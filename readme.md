...
本仓库为针对两个 AI 爬虫工具的研究学习报告，以及对 [marathon_calendar](https://github.com/ferryhe/marathon_calendar) 和 AI_actuarial_inforsearch 两个项目的爬虫改进建议。
...
- **AI_actuarial_inforsearch**（Python）— 精算信息搜索平台，需引入 AI 爬虫能力
